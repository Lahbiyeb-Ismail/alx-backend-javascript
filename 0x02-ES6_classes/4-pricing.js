...
export default class Pricing {
  constructor(amount, currency) {
    ...
    if (!(currency instanceof Currency)) throw new TypeError('currency must be instanceof Currency');
  ...
  set currency(value) {
    if (!(value instanceof Currency)) throw new TypeError('currency must be instanceof Currency');
